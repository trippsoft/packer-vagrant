...
locals {
    ...
    project_directory = replace(path.root, "/rocky/02-cis", "")
    hyperv_source_path = "${local.project_directory}/rocky/01-base/output/${var.vm_name_prefix}/hyperv"
    ...
    vmware_source_path = "${local.project_directory}/rocky/01-base/output/${var.vm_name_prefix}/vmware/${var.vm_name_prefix}_base.vmx"
